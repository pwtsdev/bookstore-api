import { API_AUTHORS, API_BOOKS, API_COVER, API_ORDERS, API_STATUS } from '@const/endpoints.const';
...
export function ordersStatusUrl(id: number): string {
  return buildResourceUrl(API_ORDERS, id) + API_STATUS;
}
